...
import (
	...
	"github.com/nholuongut/flux/cluster/mock"
	"github.com/nholuongut/flux/git"
	"github.com/nholuongut/flux/git/gittest"
	"github.com/nholuongut/flux/image"
	"github.com/nholuongut/flux/manifests"
	registryMock "github.com/nholuongut/flux/registry/mock"
...
var (
	...
	oldImage      = "quay.io/nholuongut/helloworld:master-a000001"
	oldRef, _     = image.ParseRef(oldImage)
	sidecarImage  = "nholuongut/sidecar:master-a000001"
	...
	testServiceRef, _ = image.ParseRef("quay.io/nholuongut/test-service:1")

	oldLockedImg    = "quay.io/nholuongut/locked-service:1"
	oldLockedRef, _ = image.ParseRef(oldLockedImg)

	newLockedImg     = "quay.io/nholuongut/locked-service:2"
	...
	semverHwImg    = "quay.io/nholuongut/helloworld:3.0.0"
	...
	newHwRef, _ = image.ParseRef("quay.io/nholuongut/helloworld:master-a000002")
	// this is what we expect things to be updated to
	newSidecarRef, _ = image.ParseRef("nholuongut/sidecar:master-a000002")
	// this is what we store in the registry cache
	canonSidecarRef, _ = image.ParseRef("index.docker.io/nholuongut/sidecar:master-a000002")
