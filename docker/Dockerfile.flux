...
LABEL maintainer="Flux CD <https://github.com/nholuongut/flux/issues>" \
      org.opencontainers.image.title="flux" \
      org.opencontainers.image.description="The GitOps operator for Kubernetes" \
      org.opencontainers.image.url="https://github.com/nholuongut/flux" \
      org.opencontainers.image.source="git@github.com:nholuongut/flux" \
      ...
      org.label-schema.url="https://github.com/nholuongut/flux" \
      org.label-schema.vcs-url="git@github.com:nholuongut/flux" \
