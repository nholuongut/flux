...
This chart bootstraps a [Flux](https://github.com/nholuongut/flux) deployment on
...
[helm-operator](https://github.com/nholuongut/helm-operator) will wait
...
# Git repo
 ...
 - Example of a test repo: https://github.com/nholuongut/flux-get-started

## Installation

We put together a simple [Get Started
tutorial](https://github.com/nholuongut/en/latest/tutorials/get-started-helm.html) which takes about 5-10 minutes to follow.
...
Add the nholuongut repo:

```sh
helm repo add nholuongut https://charts.https://github.com/nholuongut
```

#### To install the chart with the release name `flux`

Replace `nholuongut/flux-get-started` with your own git repository and run helm install:

```sh
$ helm install --name flux \
--set git.url=git@github.com:nholuongut/flux-get-started \
--namespace flux \
nholuongut/flux
```
...
```sh
kubectl apply -f https://raw.githubusercontent.com/nholuongut/flux/helm-0.10.1/deploy-helm/flux-helm-release-crd.yaml
```
...
Find the SSH public key by installing [fluxctl](https://github.com/nholuongut/en/latest/references/fluxctl.html) and
running:
...
| -----------------------------------------------   | ---------------------------------------------------- | ---
| `image.repository`                                | `docker.io/nholuongut/flux`                              | Image repository
...
| `git.email`                                       | `support@https://github.com/nholuongut`                                | Email to use as git committer
...
| `registry.useTimestampLabels`                     | `None`                                               | Allow usage of (RFC3339) timestamp labels from (canonical) image refs that match these glob expressions; if empty, 'index.docker.io/nholuongut/*' images are allowed
...
| `helmOperator.repository`                         | `docker.io/nholuongut/helm-operator`                     | Helm operator image repository
