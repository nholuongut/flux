...
import (
	...
	helmintegrationsfluxnholuongutv1alpha2 "github.com/nholuongut/flux/integrations/apis/helm.integrations.flux.https://github.com/nholuongut/v1alpha2"
	...
	v1alpha2 "github.com/nholuongut/flux/integrations/client/listers/helm.integrations.flux.https://github.com/nholuongut/v1alpha2"
...
func NewFilteredFluxHelmReleaseInformer(client versioned.Interface, namespace string, resyncPeriod time.Duration, indexers cache.Indexers, tweakListOptions internalinterfaces.TweakListOptionsFunc) cache.SharedIndexInformer {
	return cache.NewSharedIndexInformer(
		...
		&helmintegrationsfluxnholuongutv1alpha2.FluxHelmRelease{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *fluxHelmReleaseInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&helmintegrationsfluxnholuongutv1alpha2.FluxHelmRelease{}, f.defaultInformer)
}
