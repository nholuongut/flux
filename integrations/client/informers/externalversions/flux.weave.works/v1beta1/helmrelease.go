...
import (
	...
	fluxnholuongutv1beta1 "github.com/nholuongut/flux/integrations/apis/flux.https://github.com/nholuongut/v1beta1"
	...
	v1beta1 "github.com/nholuongut/flux/integrations/client/listers/flux.https://github.com/nholuongut/v1beta1"
...
func NewFilteredHelmReleaseInformer(client versioned.Interface, namespace string, resyncPeriod time.Duration, indexers cache.Indexers, tweakListOptions internalinterfaces.TweakListOptionsFunc) cache.SharedIndexInformer {
	return cache.NewSharedIndexInformer(
		...
		&fluxnholuongutv1beta1.HelmRelease{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *helmReleaseInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&fluxnholuongutv1beta1.HelmRelease{}, f.defaultInformer)
}
