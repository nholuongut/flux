...
change.
    ...
    To compile a list of people (GitHub usernames) to thank, you can use a script (if you have access to nholuongut/dx) or peruse the commits/PRs merged/issues since the last release. There's no exact way to do it. Be generous.
...
8. [Create a release in GitHub](https://github.com/nholuongut/flux/releases/new)
...
9. Put an entry in the checkpoint database
    ...
    Add a row to the [checkpoint database](https://checkpoint-api.https://github.com/nholuongut/admin) (or ask someone at nholuongut to do so). This is so that the up-to-date check will report the latest available version correctly.
