...
README](https://github.com/nholuongut/flux/blob/master/chart/flux/README.md#).
...
In this next step you install Flux using `helm`. Simply
 ...
 1. Fork [`nholuongut/flux-get-started`](https://github.com/nholuongut/flux-get-started)
    on GitHub and replace the `nholuongut` with your GitHub username in
    [here](https://github.com/nholuongut/flux-get-started/blob/master/releases/ghost.yaml#L13)
 1. Install Flux and the Helm operator by specifying your fork URL:
    ...
    - Using a private git server:
      ...
      See the [README of the chart](https://github.com/nholuongut/flux/blob/master/chart/flux/README.md#to-install-flux-with-the-helm-operator-and-a-private-git-repository)
...
[`nholuongut/helm-operator-get-started` repository](https://github.com/nholuongut/helm-operator-get-started).
