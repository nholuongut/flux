...
deployment](https://github.com/nholuongut/flux-get-started) and click on the
"Fork" button.
...
-    https://github.com/nholuongut/tag.init: regexp:^3.*
-    https://github.com/nholuongut/tag.podinfod: semver:~1.3
+    https://github.com/nholuongut/tag.init: glob:1.4.*
+    https://github.com/nholuongut/tag.podinfod: glob:1.4.*
 spec:
   strategy:
     rollingUpdate:
```
...
@@ -10,6 +10,7 @@ metadata:
   ...
   annotations:
     ...
     https://github.com/nholuongut/tag.init: glob:1.4.*
     https://github.com/nholuongut/tag.podinfod: glob:1.4.*
+    https://github.com/nholuongut/locked: 'true'
 spec:
   strategy:
     rollingUpdate:
```
