...
| **Git repo & key etc.**
| --git-url                                        |                          | URL of git repo with Kubernetes manifests; e.g., `git@github.com:nholuongut/flux-get-started`
...
| --registry-use-labels                            | `["index.docker.io/nholuongut/*", "index.docker.io/nholuongut/*"]` | use the timestamp (RFC3339) from labels for (canonical) image refs that match these glob expressions
