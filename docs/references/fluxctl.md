...
page](https://github.com/nholuongut/flux/releases).
...
Flags:
  ...
  -u, --url string                      Base URL of the Flux API (defaults to "https://cloud.https://github.com/nholuongut/api/flux" if a token is provided); you can also set the environment variable FLUX_URL
...
default:deployment/helloworld  helloworld  quay.io/nholuongut/helloworld:master-a000001  ready
                               sidecar     quay.io/nholuongut/sidecar:master-a000002
```
...
default:deployment/helloworld  helloworld  quay.io/nholuongut/helloworld
                               ...
                               sidecar     quay.io/nholuongut/sidecar
...
default:deployment/helloworld  success  helloworld: quay.io/nholuongut/helloworld:master-a000001 -> master-9a16ff945b9e
...
WORKLOAD                       CONTAINER   IMAGE                                             RELEASE  POLICY
default:deployment/helloworld  helloworld  quay.io/nholuongut/helloworld:master-9a16ff945b9e ready    automated
                               sidecar     quay.io/nholuongut/sidecar:master-a000002
```

Automation can also be enabled by adding the annotation
`https://github.com/nholuongut/automated: "true"` to the deployment.
...
$ fluxctl list-workloads --namespace=default
WORKLOAD                       CONTAINER   IMAGE                                             RELEASE  POLICY
default:deployment/helloworld  helloworld  quay.io/nholuongut/helloworld:master-9a16ff945b9e ready
                               sidecar     quay.io/nholuongut/sidecar:master-a000002
```
...
$ fluxctl release --workload=default:deployment/helloworld --update-image=quay.io/nholuongut/helloworld:master-a000001
Submitting release ...
Commit pushed: 33ce4e3
Applied 33ce4e38048f4b787c583e64505485a13c8a7836
WORKLOAD                     STATUS   UPDATES
default:deployment/helloworld  success  helloworld: quay.io/nholuongut/helloworld:master-9a16ff945b9e -> master-a000001
...
| git-email      | committer email            | `support@https://github.com/nholuongut`
...
```sh
quay.io/nholuongut/helloworld:master-9a16ff945b9e
```
...
Automation can be enabled with `https://github.com/nholuongut/automated: "true"`. Image
filtering annotations take the form
`https://github.com/nholuongut/tag.<container-name>: <filter-type>:<filter-value>` or 
`filter.https://github.com/nholuongut/<container-name>: <filter-type>:<filter-value>`. Values of
...
metadata:
  ...
  annotations:
    ...
    https://github.com/nholuongut/tag.podinfod: semver:~1.3
spec:
  selector:
    matchLabels:
      app: podinfo
...
2. The `https://github.com/nholuongut/tag.`... references the container name `podinfod`, this will change based on your container name. If you have multiple containers you would have multiple lines like that.
3. The value for the `https://github.com/nholuongut/tag.`... annotation should includes the filter pattern type, in this case `semver`.

Annotations can also be used to tell Flux to temporarily ignore certain manifests
using `https://github.com/nholuongut/ignore: "true"`. Read more about this in the [FAQ](../faq.md).
