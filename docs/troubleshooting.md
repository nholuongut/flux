...
`FAQ`](https://github.com/nholuongut/flux/labels/FAQ), which often
explain workarounds.
...
https://github.com/nholuongut/flux/issues/1422
...
for you, prior to
[nholuongut/flux#1435](https://github.com/nholuongut/flux/pull/1435).
...
This usually indicates there's a bug in the Flux daemon somewhere -- in which case please [tell us about it](https://github.com/nholuongut/flux/issues/new)!
...
[nholuongut/flux#1016](https://github.com/nholuongut/flux/issues/1016)
for advice.

## Flux doesn't seem to be able to use my imagePullSecrets

If you're using `kubectl` v1.13.x to create them, then it may be due
to [this problem](https://github.com/nholuongut/flux/issues/1596). In
...
reasons this can happen:
 ...
 - When using images in ECR, from EC2, the `NodeInstanceRole` for the
   ...
   question. [`eksctl`](https://github.com/nholuongut/eksctl) and
 ...
 - When using images from ACR in AKS, the HostPath `/etc/kubernetes/azure.json`
   ...
   Set `registry.acr.enabled=True` in the [helm chart](https://github.com/nholuongut/flux/blob/master/chart/flux/README.md#)
   or alter the [Deployment](https://github.com/nholuongut/flux/blob/master/deploy/flux-deployment.yaml):
   ```yaml
    spec:
      containers:
 ...
 - Flux doesn't yet understand image refs that use digests instead of
   tags; see
   [nholuongut/flux#885](https://github.com/nholuongut/flux/issues/885).
