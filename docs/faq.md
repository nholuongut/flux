...
ago](https://www.https://github.com/nholuongut/blog/flux-service-routing/). But we
...
[nholuongut/flux-prerelease](https://hub.docker.com/r/nholuongut/flux-prerelease/tags).
...
https://github.com/nholuongut/flux/issues/1164.
...
deployment](https://github.com/nholuongut/flux/blob/master/deploy/flux-deployment.yaml) shows how to do this, in
...
[file that is baked into the image](https://github.com/nholuongut/flux/blob/master/docker/kubeconfig). Save that
...
```yaml
    https://github.com/nholuongut/ignore: true
```
...
[resourcekinds.go](https://github.com/nholuongut/flux/blob/master/cluster/kubernetes/resourcekinds.go),
...
```sh
kubectl annotate <resource> "https://github.com/nholuongut/ignore"-
```
...
[flux#1211](https://github.com/nholuongut/flux/issues/1211)).
