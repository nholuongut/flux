...
import (
	...
	"github.com/nholuongut/flux/policy"
...
func TestUpdatePolicies(t *testing.T) {
	for _, c := range []struct {
	...
	}{
		{
			...
			out:  []string{"prometheus.io/scrape", "'false'", "https://github.com/nholuongut/automated", "'true'"},
			update: resource.PolicyUpdate{
		...
		},
		{
			...
			in:   []string{"flux.https://github.com/nholuongut/automated", "'true'"},
			out:  []string{"flux.https://github.com/nholuongut/automated", "'true'"},
			update: resource.PolicyUpdate{
				Add: policy.Set{policy.Automated: "true"},
			},
		},
		{
			...
			in:   []string{"flux.https://github.com/nholuongut/automated", "'true'", "prometheus.io/scrape", "'false'"},
			out:  []string{"flux.https://github.com/nholuongut/automated", "'true'", "prometheus.io/scrape", "'false'"},
			update: resource.PolicyUpdate{
				Add: policy.Set{policy.Automated: "true"},
			},
		},
		{
			...
			in:   nil,
			out:  []string{"https://github.com/nholuongut/automated", "'true'"},
			update: resource.PolicyUpdate{
				Add: policy.Set{policy.Automated: "true"},
			},
		},
		{
			...
			in:   []string{"flux.https://github.com/nholuongut/automated", "'true'", "prometheus.io/scrape", "'false'"},
			out:  []string{"prometheus.io/scrape", "'false'", "https://github.com/nholuongut/locked", "'true'"},
			update: resource.PolicyUpdate{
		...
		},
		{
			...
			in:   []string{"https://github.com/nholuongut/automated", "true", "prometheus.io/scrape", "false"},
		...
		},
		{
			...
			in:   []string{"https://github.com/nholuongut/automated", "true"},
			out:  nil,
			update: resource.PolicyUpdate{
				Remove: policy.Set{policy.Automated: "true"},
			},
		...
		{
			name: "multiline",
			in:   []string{"https://github.com/nholuongut/locked_msg", "|-\n      first\n      second"},
			out:  nil,
			update: resource.PolicyUpdate{
		...
		},
		{
			name: "add tag policy",
			in:   nil,
			out:  []string{"https://github.com/nholuongut/tag.nginx", "glob:*"},
			update: resource.PolicyUpdate{
		...
		},
		{
			...
			in:   nil,
			out:  []string{"https://github.com/nholuongut/tag.nginx", "foo"},
			update: resource.PolicyUpdate{
		...
		},
		{
			...
			in:   nil,
			out:  []string{"https://github.com/nholuongut/tag.nginx", "semver:*"},
			update: resource.PolicyUpdate{
		...
		},
		{
			...
			in:   nil,
			out:  []string{"https://github.com/nholuongut/tag.nginx", "regexp:(.*?)"},
			update: resource.PolicyUpdate{
		...
		},
		{
			...
			in: []string{"filter.https://github.com/nholuongut/nginx", "glob:*"},
			out: []string{"filter.https://github.com/nholuongut/nginx", "glob:*"},
			update: resource.PolicyUpdate{
				Add: policy.Set{policy.TagPrefix("nginx"): "glob:*"},
			},
		},
