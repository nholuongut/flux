  ...
  template:
    ...
    spec:
      ...
      - name: greeter
        ...
        - containerPort: 80
      - name: sidecar
        image: nholuongut/sidecar:master-a000001
        args:
        - -addr=:8080
        ports:
        - containerPort: 8080
...
metadata:
  ...
  annotations:
    ...
    flux.https://github.com/nholuongut/tag.greeter: semver:*
spec:
  minReadySeconds: 1
  replicas: 5
  template:
...
spec:
  ...
  template:
    ...
    spec:
      containers:
      - name: locked-service
        image: quay.io/nholuongut/locked-service:1
        args:
        - -msg=Ahoy
        ports:
        - containerPort: 80
...
spec:
  ...
  template:
    ...
    spec:
      containers:
      - name: test-service
        image: quay.io/nholuongut/test-service:1
        args:
        - -msg=Ahoy
        ports:
        - containerPort: 80
  ...
  template:
    ...
    spec:
      ...
      - name: greeter
        ...
        - containerPort: 80
      - name: sidecar
        image: nholuongut/sidecar:master-a000002
        args:
        - -addr=:8080
        ports:
        - containerPort: 8080
