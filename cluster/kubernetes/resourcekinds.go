...
import (
	...
	hr_v1 "github.com/nholuongut/helm-operator/pkg/apis/helm.https://github.com/nholuongut/v1"
	...
	hr_v1beta1 "github.com/nholuongut/flux/integrations/apis/flux.https://github.com/nholuongut/v1beta1"
	fhr_v1alpha2 "github.com/nholuongut/flux/integrations/apis/helm.integrations.flux.https://github.com/nholuongut/v1alpha2"
...
// `resource.ID`.
const AntecedentAnnotation = "flux.https://github.com/nholuongut/antecedent"
...
/////////////////////////////////////////////////////////////////////////////
// helm.integrations.flux.https://github.com/nholuongut/v1alpha2 FluxHelmRelease
...
func makeFluxHelmReleaseWorkload(fluxHelmRelease *fhr_v1alpha2.FluxHelmRelease) workload {
	...
	// apiVersion & kind must be set, since TypeMeta is not populated
	fluxHelmRelease.APIVersion = "helm.integrations.flux.https://github.com/nholuongut/v1alpha2"
...
/////////////////////////////////////////////////////////////////////////////
// flux.https://github.com/nholuongut/v1beta1 HelmRelease
// flux.https://github.com/nholuongut/v1        HelmRelease
...
func makeHelmReleaseBetaWorkload(helmRelease *hr_v1beta1.HelmRelease) workload {
	...
	// apiVersion & kind must be set, since TypeMeta is not populated
	helmRelease.APIVersion = "flux.https://github.com/nholuongut/v1beta1"
...
func makeHelmReleaseStableWorkload(helmRelease *hr_v1.HelmRelease) workload {
	...
	// apiVersion & kind must be set, since TypeMeta is not populated
	helmRelease.APIVersion = "helm.https://github.com/nholuongut/v1"
	helmRelease.Kind = "HelmRelease"
	return workload{
		status:      helmRelease.Status.ReleaseStatus,
		podTemplate: podTemplate,
