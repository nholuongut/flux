...
const (
	...
	ImageRegistryPrefix   = "registry.https://github.com/nholuongut/"
	// ImageRepositoryPrefix is the annotation key prefix for image
	// repository path mappings.
	ImageRepositoryPrefix = "repository.https://github.com/nholuongut/"
	// ImageRepositoryPrefix is the annotation key prefix for image
	// tag path mappings.
	ImageTagPrefix        = "tag.https://github.com/nholuongut/"
)
