...
import (
	...
	"github.com/nholuongut/flux/cluster/kubernetes/resource"
)
...
`,
		...
		{
			original: `apiVersion: flux.https://github.com/nholuongut/v1beta1
kind: HelmRelease
metadata:
  name: ghost
  namespace: demo
  annotations:
    flux.https://github.com/nholuongut/automated: "false"
    flux.https://github.com/nholuongut/tag.chart-image: glob:1.21.*
spec:
  values:
    image: bitnami/ghost
    tag: 1.21.5-r0
`,
			modified: `apiVersion: flux.https://github.com/nholuongut/v1beta1
kind: HelmRelease
metadata:
  name: ghost
  namespace: demo
...
metadata:
  ...
  namespace: namespace
  annotations:
   flux.https://github.com/nholuongut/tag.container: glob:1.4.*
spec:
  values:
    container:
      image: 
...
metadata:
  name: name
  annotations:
    flux.https://github.com/nholuongut/locked: "true"
spec:
  template:
    spec:
      containers:
...
metadata:
  ...
  namespace: demo
  annotations:
    flux.https://github.com/nholuongut/automated: "true"
spec:
  values:
    image: bitnami/ghost
    tag: 1.21.6
