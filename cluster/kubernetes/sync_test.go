...
import (
	...
	helmopfake "github.com/nholuongut/helm-operator/pkg/client/clientset/versioned/fake"
	...
	fhrfake "github.com/nholuongut/flux/integrations/client/clientset/versioned/fake"
	"github.com/nholuongut/flux/resource"
	"github.com/nholuongut/flux/sync"
)
...
metadata:
  namespace: foobar
  name: dep2
  annotations: {flux.https://github.com/nholuongut/ignore: "true"}
`
...
metadata:
  ...
  name: dep1
  annotations:
    flux.https://github.com/nholuongut/ignore: "true"
spec:
  metadata:
    labels: {app: bar}
`
...
`
		...
		annots["flux.https://github.com/nholuongut/ignore"] = "true"
