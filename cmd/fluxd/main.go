...
import (
	...
	helmopclient "github.com/nholuongut/helm-operator/pkg/client/clientset/versioned"
	...
	"github.com/nholuongut/flux/checkpoint"
	"github.com/nholuongut/flux/cluster"
	"github.com/nholuongut/flux/cluster/kubernetes"
	"github.com/nholuongut/flux/daemon"
	"github.com/nholuongut/flux/git"
	"github.com/nholuongut/flux/gpg"
	transport "github.com/nholuongut/flux/http"
	"github.com/nholuongut/flux/http/client"
	daemonhttp "github.com/nholuongut/flux/http/daemon"
	"github.com/nholuongut/flux/image"
	hrclient "github.com/nholuongut/flux/integrations/client/clientset/versioned"
	"github.com/nholuongut/flux/job"
	"github.com/nholuongut/flux/manifests"
	"github.com/nholuongut/flux/registry"
	"github.com/nholuongut/flux/registry/cache"
	registryMemcache "github.com/nholuongut/flux/registry/cache/memcached"
	registryMiddleware "github.com/nholuongut/flux/registry/middleware"
	"github.com/nholuongut/flux/remote"
	"github.com/nholuongut/flux/ssh"
	fluxsync "github.com/nholuongut/flux/sync"
)
...
func main() {
	...
	var (
		...
		// Git repo & key etc.
		gitURL       = fs.String("git-url", "", "URL of git repo with Kubernetes manifests; e.g., git@github.com:nholuongut/flux-get-started")
		...
		gitEmail     = fs.String("git-email", "support@https://github.com/nholuongut", "email to use as git committer")
		...
		registryUseLabels    = fs.StringSlice("registry-use-labels", []string{"index.docker.io/nholuongut/*", "index.docker.io/nholuongut/*"}, "use the timestamp (RFC3339) from labels for (canonical) image refs that match these glob expression")
