		...
		},
		{
			...
			input: input{
				args: []string{
					"config",
					"user.email",
					"support@https://github.com/nholuongut",
				},
				config: gitCmdConfig{
					dir: "/tmp/flux-working056923691",
				},
			},
			expected: `TRACE: command="git config user.email support@https://github.com/nholuongut" out="" dir="/tmp/flux-working056923691" env=""`,
		},
		{
			name: "git notes",
			input: input{
