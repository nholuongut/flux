...
import (
	...
	"github.com/nholuongut/flux/api/v11"
	...
	"github.com/nholuongut/flux/event"
...
const (
	...
	container         = "greeter"
	ns                = "default"
	oldHelloImage     = "quay.io/nholuongut/helloworld:3" // older in time but newer version!
	newHelloImage     = "quay.io/nholuongut/helloworld:2"
	currentHelloImage = "quay.io/nholuongut/helloworld:master-a000001"
